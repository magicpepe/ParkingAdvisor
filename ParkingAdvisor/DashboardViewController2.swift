...
import UIKit
class DashboardViewController2: UIViewController {
...
//        configureMyCircleProgress()
        ...
        Timer.scheduledTimer(timeInterval: 0.015, target: self, selector: #selector(DashboardViewController2.updateProgress), userInfo: nil, repeats: true)
